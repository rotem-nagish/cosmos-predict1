# code from https://github.com/KlingTeam/VFRTok/blob/main/modelling/discriminators/discriminator_dino.py
...
from cosmos_predict1.tokenizer.training.losses import dist
...
class DinoDisc(nn.Module):
    def __init__(self, dino_ckpt_path='https://dl.fbaipublicfiles.com/dino/dino_deitsmall16_pretrain/dino_deitsmall16_pretrain.pth',
        ...
        self.dino_proxy: FrozenDINOSmallNoDrop = d
        # dino_C = self.dino_proxy[0].embed_dim
        dino_C = self.dino_proxy.embed_dim
